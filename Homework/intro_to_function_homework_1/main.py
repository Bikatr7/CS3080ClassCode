...
## I hope you enjoy grading my code, and I hope you have a great day!

## An example of some python code I've written before to prove that this isn't simply auto-generated code:
